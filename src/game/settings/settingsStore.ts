...
export function t (key: string, lan: LangCode = getLanguage()): string
{
    const table: Record<string, Record<LangCode, string>> = {
        ...
        unlock: { zh: '解锁', 'zh-Hant': '解鎖', ja: 'アンロック', en: 'Unlock' },
        unlocked: { zh: '已解锁', 'zh-Hant': '已解鎖', ja: 'アンロック', en: 'Unlocked' },
        buy: { zh: '购买', 'zh-Hant': '購買', ja: '購入する', en: 'Buy' },
        purchased: { zh: '已购买', 'zh-Hant': '已購買', ja: '購入済み', en: 'Purchased' },
        p_101_name: { zh: '神枪手', 'zh-Hant': '神槍手', ja: 'スナイパー', en: 'Marksman' },
        p_101_des: { zh: '你曾接受过专业训练，对枪弹非常熟悉。\n（解锁后永久有效，可选择该角色进入游戏。)', 'zh-Hant': '你曾接受過專業訓練，對槍彈非常熟悉。\n（解鎖後永久有效，可選擇該角色進入遊戲。)', ja: 'プロの訓練を経験したあなたは銃と弾丸に詳しい。\n（アンロック後永遠に有効で、当該キャラを選んでゲームを始めることができる。）', en: 'Well trained in shooting, and familiar with firearms. \n (Once unlocked it never expires, and is available for all future games.)' },
        p_101_effect: { zh: '命中提高到125%', 'zh-Hant': '命中提高到125%', ja: '命中率を125%までアップ', en: 'Hit increases to 125%' },
        p_102_name: { zh: '大块头', 'zh-Hant': '大塊頭', ja: 'マッチョ', en: 'Athlete' },
        p_102_des: { zh: '坚持不懈地锻炼，你的体格优于常人。\n（解锁后永久有效，可选择该角色进入游戏。)', 'zh-Hant': '堅持不懈地鍛煉，你的體格優於常人。\n（解鎖後永久有效，可選擇該角色進入遊戲。)', ja: '絶えがたい身体鍛錬をしてきたあなたは一般人よりもかなりがっちりしている。\n（アンロック後永遠に有効で、当該キャラを選んでゲームを始めることができる。）', en: 'Has exercised for a long time, and therefore has a stronger physique and faster recovery times. \n (Once unlocked it never expires, and is available for all future games.)' },
        p_102_effect: { zh: '生命值提高到125%', 'zh-Hant': '生命值提高到125%', ja: 'HPを125%までアップ', en: 'HP increases to 125%' },
        p_103_name: { zh: '拾荒者', 'zh-Hant': '拾荒者', ja: 'くず拾い', en: 'Scavenger' },
        p_103_des: { zh: '你善于在垃圾堆里寻找价值。\n（解锁后永久有效，可选择该角色进入游戏。)', 'zh-Hant': '你擅於在垃圾堆裡尋找價值。\n（解鎖後永久有效，可選擇該角色進入遊戲。)', ja: 'あなたはゴミの山の中から価値のあるものを探し出すことに長けている。\n（アンロック後永遠に有効で、当該キャラを選んでゲームを始めることができる。）', en: 'Good at scavenging useful items from rubble. \n (Once unlocked it never expires, and is available for all future games.)' },
        p_103_effect: { zh: '副本获得资源提高到110%', 'zh-Hant': '副本獲得資源110%', ja: 'ドロップ量を110%までアップ', en: 'Item drops increased by 10%.' },
        p_104_name: { zh: '社交达人', 'zh-Hant': '社交達人', ja: '社交の達人', en: 'Communicator' },
        p_104_des: { zh: '你善于跟人相处，并获得别人的青睐和帮助。\n（解锁后永久有效，可选择该角色进入游戏。)', 'zh-Hant': '你善於跟人相處，並獲得他人的青睞和幫助。\n（解鎖後永久有效，可選擇該角色進入遊戲。)', ja: '人との付き合いが上手で、他人から好かれて助けられます。\n（アンロック後、永久に有効です。このキャラを選んでゲームを始めることが可能です。）ｴ', en: 'You are good with interacting with people. You\'re able to quickly earn their trust and aid. \n (Unlocking this permanently allows you to choose this character).' },
        p_104_effect: { zh: '额外获得NPC大量礼物。拒绝NPC求助，亲密度不会下降。', 'zh-Hant': '額外獲得NPC大量禮物。拒絕NPC求助，親密度不會下降。', ja: 'NPCから大量のギフトがもらえる。NPCの援助要請を断っても親密度が下がらない。', en: 'Gain a large bonus to NPC interactions. Refusing an NPC\'s request will not cause relationship points to drop.' },
        p_105_name: { zh: '军用背包', 'zh-Hant': '軍用背包', ja: '軍用リュック', en: 'Military Grade Backpack' },
        p_105_des: { zh: '立即制作一个军用背包，负重增加到60。', 'zh-Hant': '立即製作一個軍用背包，負重增加到60。', ja: '直ちに軍用リュック一つを作成して、最大負荷を60まで上昇。ﾌk', en: 'Instantly create a military backpack increasing your storage space to 60.' },
        p_105_effect: { zh: '获得后永久有效。', 'zh-Hant': '獲得後永久有效。', ja: '入手後永久に有効。', en: 'Buff stays permanently after purchase.' },
        p_106_name: { zh: '靴子', 'zh-Hant': '靴子', ja: 'ブーツ', en: 'Boots' },
        p_106_des: { zh: '立即制作一双靴子，玩家移动速度提高到125%', 'zh-Hant': '立即製作一雙靴子，玩家移動速度提高到125%', ja: '直ちにブーツ一足を作成して、移動スピードを125%まで上昇。', en: 'Instantly create a pair of boots. Your movement speed will be increased to 125%.' },
        p_106_effect: { zh: '获得后永久有效。', 'zh-Hant': '獲得後永久有效。', ja: '入手後永久に有効。', en: 'Buff stays permantly after purchase.' },
        p_107_name: { zh: '狗舍', 'zh-Hant': '狗屋', ja: '犬小屋', en: 'Kennel' },
        p_107_des: { zh: '立即建造一间狗舍，增强抵御僵尸夜袭的能力。', 'zh-Hant': '立即建造一間狗屋，增強抵禦僵屍夜襲的能力。', ja: '直ちに犬小屋一つを作成して、ゾンビによる夜間襲撃への防御確率を上昇。ﾎﾞ', en: 'Instantly build a kennel. Dogs help you fight off zombie attacks at night.' },
        p_107_effect: { zh: '获得后永久有效。', 'zh-Hant': '獲得後永久有效。', ja: '入手後永久に有効。', en: 'Buff stays permantly after purchase.' },
        p_108_name: { zh: '人物:老罗', 'zh-Hant': '人物：老羅', ja: 'キャラ：羅じいさん', en: 'Character: Mr. Luo' },
        p_108_des: { zh: '作为前陆战队军官，老罗的优势在于枪械，甚至能自己制作无壳子弹。但是长期酗酒，导致他的战斗力非常不稳定。', 'zh-Hant': '身為前陸戰隊軍官，老羅的優勢在於槍械使用能力，他甚至還能自己製作無殼子彈，但因為長期酗酒，導致戰鬥力相當不穩定。', ja: '元陸戦隊幹部として、羅じいさんは銃使いが上手で、さらに薬きょうがない弾丸も作れます。しかし、彼は呑兵衛だから戦闘力が安定しないようです。', en: 'As a former marine officer, Mr. Luo knows how to use guns and make bullets, but his long-term alcohol abuse makes him an unstable force in combat.' },
        p_108_effect: { zh: '可以建造雷区，使用自制炸药抵御僵尸夜袭\n可以建造机床，生产子弹、炸药和僵尸诱饵\n可以喝酒提升心情值，但如果心情值过低导致枪械命中率下降', 'zh-Hant': '可以建造地雷區，利用自製炸藥抵抗殭屍夜襲\n可以建造機床，生產子彈、炸藥和殭屍誘餌\n可以喝酒提升心情值，但若心情值過低會造成槍械命中率下降', ja: '爆発ゾーンを仕掛けて、手作り爆薬でゾンビの夜襲を凌げる\n旋盤を作り、弾丸、爆薬とゾンビ餌の生産が可能になる\n酒を飲んで気分ゲージを溜めることが出来るが、気分ゲージが低くなると銃類の命中率が悪くなる', en: 'Can build mine fields and use homemade explosives to defend against night raids from zombies.\nCan make machine tools, bullets, explosives, and zombie bait.\nCan increase your Mood by drinking with you (a low Mood will reduce your shooting accuracy).' },
        p_109_name: { zh: '人物:雅子', 'zh-Hant': '人物：雅子', ja: 'キャラ：雅子', en: 'Character: Yazi' },
        p_109_des: { zh: '雅子是一个来自二次元的电气工程师，喜欢把各种奇思妙想变成现实。', 'zh-Hant': '雅子是一個來自二次元的電氣工程師，喜歡把各種奇思妙想變成現實。', ja: '雅子は二次元から来た電気エンジニアで、様々な奇想を現実に変えるのが好きです。', en: 'Yazi is an electrical engineer from another dimension who loves turning wild ideas into reality.' },
        p_109_effect: { zh: '可以维修发电厂获得电力，可以制造电网、电锯和电极武器', 'zh-Hant': '可以維修發電廠獲得電力，可以製造電網、電鋸和電極武器', ja: '発電所を修理して電力を得られ、電網・チェーンソー・電極武器を製造できる', en: 'Can repair the power plant for electricity, and craft electric fences, chainsaws, and electrode weapons' },
    };
